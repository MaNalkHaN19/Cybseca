...
const CertainCircumstances: React.FC = () => {
  return (
    <div className="w-11/12 flex flex-col md:flex-row h-auto md:h-96 mx-auto lg:mx-16 p-4 md:p-0">
      <div className="bg-gray-200  md:w-3/5 h-64 md:h-96 rounded-3xl mb-4 md:mb-0 "></div>
      <div className="flex flex-col md:w-1/3">
        {/* This div will be hidden on small screens */}
        <div className="hidden md:block bg-gray-200 w-full h-64 md:h-3/4 rounded-3xl md:-ml-10 mb-4 md:mb-0"></div>
        <div className="bg-white rounded-tl-3xl w-full md:w-11/12 h-auto -mt-0.5 md:h-3/4 md:-ml-3 p-4 md:p-0">
          <div className="bg-indigo-500 w-full rounded-3xl mt-4 ml-0 md:ml-4 flex flex-col md:flex-row p-4 md:p-7 text-gray-200">
            <div className="w-full md:w-1/3 bg-gray-200 rounded-3xl h-24 md:h-auto mb-4 md:mb-0"></div>
